...
/**
 * @describe
 * @author ：king9999 on 2018/7/22 16：41
 * @email：wangwenbinc@enn.cn
 */
data class DiscoveryListInfo(var errorCode: Int, var errorMessage: String, var count: Int, var total: Int, var nextPageUrl: Any?, var itemList: List<ItemListBean>?) : BaseResponseEntity(errorCode, errorMessage) {
